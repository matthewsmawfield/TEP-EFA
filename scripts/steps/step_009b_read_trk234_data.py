...
import sys
sys.path.insert(0, '/Users/matthewsmawfield/www/TEP-EFA')
...
PROJECT_ROOT = Path('/Users/matthewsmawfield/www/TEP-EFA')


def main():
    """Read TRK-2-34 data and extract Doppler measurements."""
    logger = StepLogger("step_009b_read_trk234_data", PROJECT_ROOT)
    logger.header("STEP 009b: READ TRK-2-34 DATA FORMAT")
    ...
    if not trk_file.exists():
        ...
        output_file = output_dir / 'messenger_2005_trk234_extracted.json'
