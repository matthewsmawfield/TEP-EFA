"""
Step 027: PDS API Search for Juno 2013 Earth Flyby Data
...
def search_with_peppi():
    ...
    logger = StepLogger("step_027_pds_api_search_juno", PROJECT_ROOT)
    logger.header("STEP 027: PDS API SEARCH FOR JUNO 2013 DATA")
    ...
    try:
        ...
        output_file = PROJECT_ROOT / 'results' / 'step027_pds_api_search.json'
...
def search_with_direct_api():
    ...
    logger = StepLogger("step_027_pds_api_search_juno", PROJECT_ROOT)
    logger.header("STEP 027b: DIRECT PDS API SEARCH")
...
def main():
    ...
    logger.info("1. Review search results in results/step027_pds_api_search.json")
    ...
    output_file = PROJECT_ROOT / 'results' / 'step027_pds_api_search_combined.json'
    with open(output_file, 'w') as f:
        json.dump({
            'step': '027_pds_api_search_combined',
            'timestamp': datetime.now().isoformat(),
            'peppi': peppi_results,
