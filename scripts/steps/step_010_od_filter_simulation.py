"""
Step 021: Rigorous Orbit Determination Filter Simulation (3D)
=============================================================
...
def main():
    ...
    logger = StepLogger("step_021_mock_od_ekf", PROJECT_ROOT)
    start_time = time.time()
    
    logger.header("STEP 021: RIGOROUS ORBIT DETERMINATION FILTER SIMULATION")
    ...
    output_file = results_dir / 'step021_od_simulation_validation.json'
