#!/usr/bin/env python3
"""
Step 027: Fetch Continuous IRI Electron Density Along Trajectories
...
def main():
    ...
    logger = StepLogger("step_027_iri_trajectory_profile", PROJECT_ROOT)
    logger.header("STEP 027: CONTINUOUS IRI TRAJECTORY PROFILES")
    ...
    # Save results
    output_file = PROJECT_ROOT / 'results' / 'step027_iri_trajectory_profiles.json'
