...
def main():
    ...
    logger = StepLogger("step_005_dsn_data_ingestion", PROJECT_ROOT)
    start_time = time.time()
    
    logger.header("STEP 005: DSN Data Request Workflow")
    ...
    for mission, info in missions.items():
        ...
        filename = f"step005_{info['agency']}_request_{mission}.json"
