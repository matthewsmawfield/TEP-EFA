#!/usr/bin/env python3
"""
Step 025: Corrected Systematic Uncertainty Calculation
...
class CorrectedUncertaintyCalculator:
    ...
    def load_fitting_results(self):
        """Load fitting results from step_008."""
...
def main():
    ...
    logger = StepLogger("step_025_corrected_uncertainty", PROJECT_ROOT)
    start_time = time.time()
    
    logger.header("STEP 025: CORRECTED SYSTEMATIC UNCERTAINTY CALCULATION")
    ...
    # Save results
    output_file = PROJECT_ROOT / 'results' / 'step025_corrected_uncertainty.json'
