...
In unscreened regimes, the PPN parameter $\gamma - 1 \approx -2 \alpha_0^2/(1 + \alpha_0^2) \approx -2 \alpha_0^2$ with $\alpha_0 = \alpha(\phi_\infty)$; Cassini's $|\gamma - 1| < 2.3\times10^{-5}$ implies $\alpha_0 \lesssim 3\times10^{-3}$. Near massive bodies, the suppression of Temporal Shear (vanishing field gradient) suppresses the locally active PPN coupling to $\alpha_{\text{PPN}}^{\text{eff}} \ll \alpha_0$, cleanly preserving PPN bounds without invoking rigid continuous gradient suppressions.
...
Khoury, J. & Weltman, A. (2004). Temporal Shear Suppression fields: Awaiting surprises for tests of gravity in space. Phys. Rev. Lett. 93, 171104.
Hinterbichler, K. & Khoury, J. (2010). Temporal Shear Suppression fields. Phys. Rev. Lett. 104, 231301.
...
Burrage, C. & Sakstein, J. (2018). Tests of Temporal Shear Suppression gravity. Living Rev. Relativity 21, 1.
